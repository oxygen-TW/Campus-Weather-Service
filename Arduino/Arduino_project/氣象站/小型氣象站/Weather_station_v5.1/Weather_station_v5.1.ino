...
#include "DHT.h"
#define DEBUG
//#define Wait_time 26000//30sec
//#define Wait_time 56000//1min
#define Wait_time 296000//5min
//#define Wait_time 896000//15min
#define _ledpin     13
...
#define light 0
int light_detect(void);

//*-- IoT Information
#define SSID "NHSHWS"
#define PASS "66326632"
...
void updateDHT11( String T, String H )
{
  ...
  while (counter < 5 && !chk_TCP) 
  {
    ...
    cmd = GET + "&field1=" + T + "&field2=" + H + "&field3=" + light_detect() +"\r\n";
...
int light_detect()
{
  return 1023-analogRead(light);//使越暗數值越小，比較好懂
}
